...
namespace BrainfuckPlus
{
    ...
    {
        public static string Convert(string code, string methodNames,string fileAddress, string debugMode)
        {
        ...
        public static string Substitute(string code, int charIndex, string extraValidChars, string directory, bool debugMode)
        {
            ...
            GetSourceCode.GetCode($"{directory}/{code[charIndex]}.{Program.FILE_EXTENSION}", debugMode, out string v);
